...
const IDE_FILES: Record<string, { lang: string; lines: { n: number; t: ReactNode }[] }> = {
	...
	'route.ts': {
		...
		lines: [
			...
			{ n: 2, t: <><span className="text-[#c586c0]">import</span> {'{'} PublicController {'}'} <span className="text-[#c586c0]">from</span> <span className="text-[#ce9178]">&apos;@/adapters/inbound/http/controllers/PublicController&apos;</span></> },
			{ n: 3, t: <><span className="text-[#c586c0]">import</span> {'{'} AuthController {'}'} <span className="text-[#c586c0]">from</span> <span className="text-[#ce9178]">&apos;@/adapters/inbound/http/controllers/AuthController&apos;</span></> },
			{ n: 4, t: <><span className="text-[#c586c0]">import</span> {'{'} UserController {'}'} <span className="text-[#c586c0]">from</span> <span className="text-[#ce9178]">&apos;@/adapters/inbound/http/controllers/UserController&apos;</span></> },
			{ n: 5, t: <><span className="text-[#c586c0]">import</span> {'{'} auth, guest {'}'} <span className="text-[#c586c0]">from</span> <span className="text-[#ce9178]">&apos;@/adapters/inbound/http/middleware/auth&apos;</span></> },
			{ n: 6, t: '' },
	...
	'Dashboard.tsx': {
		...
		lines: [
			{ n: 1, t: <><span className="text-[#c586c0]">import</span> Navigation <span className="text-[#c586c0]">from</span> <span className="text-[#ce9178]">&apos;@/adapters/inbound/http/views/components/Navigation&apos;</span></> },
	...
	'index.ts': {
		...
		lines: [
			...
			{ n: 2, t: <><span className="text-[#c586c0]">import</span> {'{'} inertia {'}'} <span className="text-[#c586c0]">from</span> <span className="text-[#ce9178]">&apos;@/adapters/inbound/http/middleware/inertia&apos;</span></> },
			{ n: 3, t: <><span className="text-[#c586c0]">import</span> routes <span className="text-[#c586c0]">from</span> <span className="text-[#ce9178]">&apos;@/adapters/inbound/http/routes/route&apos;</span></> },
			{ n: 4, t: '' },
	...
	'SendWelcomeEmail.ts': {
		lang: 'TypeScript',
		lines: [
			{ n: 1, t: <><span className="text-[#c586c0]">import</span> WelcomeEmail <span className="text-[#c586c0]">from</span> <span className="text-[#ce9178]">&apos;@/adapters/outbound/mail/templates/WelcomeEmail&apos;</span></> },
			{ n: 2, t: <><span className="text-[#c586c0]">import</span> {'{'} User {'}'} <span className="text-[#c586c0]">from</span> <span className="text-[#ce9178]">&apos;@/core/models/User&apos;</span></> },
			{ n: 3, t: '' },
			...
			{ n: 5, t: <span className="pl-4"><span className="text-[#c586c0]">return</span> <span className="text-[#dcdcaa]">WelcomeEmail</span>({'{'} name: user.name {'}'})</span> },
			{ n: 6, t: '}' },
		],
	},
	'ProcessUpload.ts': {
		lang: 'TypeScript',
		lines: [
			{ n: 1, t: <><span className="text-[#c586c0]">import</span> {'{'} StorageDriver {'}'} <span className="text-[#c586c0]">from</span> <span className="text-[#ce9178]">&apos;@/ports/storage&apos;</span></> },
			{ n: 2, t: '' },
	...
	'pages.ts': {
		...
		lines: [
			...
			{ n: 4, t: <span className="pl-4"><span className="text-[#ce9178]">&apos;Home&apos;</span>: () =&gt; <span className="text-[#c586c0]">import</span>(<span className="text-[#ce9178]">&apos;@/adapters/inbound/http/views/pages/Home&apos;</span>),</span> },
			{ n: 5, t: <span className="pl-4"><span className="text-[#ce9178]">&apos;Dashboard&apos;</span>: () =&gt; <span className="text-[#c586c0]">import</span>(<span className="text-[#ce9178]">&apos;@/adapters/inbound/http/views/pages/Dashboard&apos;</span>),</span> },
			{ n: 6, t: <span className="pl-4"><span className="text-[#ce9178]">&apos;Users&apos;</span>: () =&gt; <span className="text-[#c586c0]">import</span>(<span className="text-[#ce9178]">&apos;@/adapters/inbound/http/views/pages/Users&apos;</span>),</span> },
			{ n: 7, t: <span className="pl-4"><span className="text-[#ce9178]">&apos;Auth/Login&apos;</span>: () =&gt; <span className="text-[#c586c0]">import</span>(<span className="text-[#ce9178]">&apos;@/adapters/inbound/http/views/pages/Auth/Login&apos;</span>),</span> },
			{ n: 8, t: <span className="pl-4"><span className="text-[#ce9178]">&apos;Auth/Register&apos;</span>: () =&gt; <span className="text-[#c586c0]">import</span>(<span className="text-[#ce9178]">&apos;@/adapters/inbound/http/views/pages/Auth/Register&apos;</span>),</span> },
			{ n: 9, t: '}' },
		],
	},
	'variables.ts': {
