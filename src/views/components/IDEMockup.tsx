...
const IDE_FILES: Record<string, { lang: string; lines: { n: number; t: ReactNode }[] }> = {
	'PublicController.ts': {
		...
		lines: [
			...
			{ n: 2, t: <><span className="text-[#c586c0]">import</span> {'{'} BaseController {'}'} <span className="text-[#c586c0]">from</span> <span className="text-[#ce9178]">&apos;./BaseController&apos;</span></> },
			{ n: 3, t: '' },
	...
	'Dashboard.tsx': {
		...
		lines: [
			{ n: 1, t: <><span className="text-[#c586c0]">import</span> Navigation <span className="text-[#c586c0]">from</span> <span className="text-[#ce9178]">&apos;../components/Navigation&apos;</span></> },
